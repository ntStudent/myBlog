...
<head>
    ...
    <link href="newTemplate/css/bootstrap.min.css" rel="stylesheet">
    <link href="newTemplate/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href="newTemplate/js/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="newTemplate/js/owl-carousel/owl.theme.css" rel="stylesheet">
    <link href="newTemplate/js/owl-carousel/owl.transitions.css" rel="stylesheet">
    <link href="newTemplate/js/easytabs/easy-responsive-tabs.css" rel="stylesheet"/>
    <link href="newTemplate/js/flex-slider/flexslider.css" rel="stylesheet" />
    <link href="newTemplate/css/prettyphoto.css" rel="stylesheet" />
    <link href="newTemplate/css/style.css" rel="stylesheet">
    <link href="newTemplate/css/style-responsive.css" rel="stylesheet">

    <!-- Add custom CSS here -->
    <link href="../newTemplate/css/custom.css" rel="stylesheet">
...
<body id="page-top">
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right menu-effect">
                                ...
                                <li class="current"><a href="./login.php" data-hover="Login">Login</a></li>
                                <?=$content2?>
                                <li>
                                    <a class="dropdown" data-hover="About&nbsp;Us&nbsp;&#9663;">About Us &#9662;</a>
                                    <ul class="v-dropdown">
                                        <li><a href="newTemplate/about.html" data-hover="About&nbsp;Us&nbsp;1">About Us 1</a></li>
                                        <li><a href="newTemplate/about.html" data-hover="About&nbsp;Us&nbsp;2">About Us 2</a></li>
                                        <li><a href="newTemplate/about.html" data-hover="About&nbsp;Us&nbsp;3">About Us 3</a></li>
                                        <li><a href="newTemplate/about.html" data-hover="About&nbsp;Us&nbsp;4">About Us 4</a></li>
                                    </ul>
                                </li>
                                <li><a href="newTemplate/portfolio.html" data-hover="Portfolio">Portfolio</a></li>
                                <li><a href="newTemplate/blog.html" data-hover="Blog">Blog</a></li>
                                <li><a href="newTemplate/single-post.html" data-hover="Blog&nbsp;-&nbsp;Single">Blog - Single</a></li>
                                <li><a href="newTemplate/contact.html" data-hover="Contact">Contact</a></li>
    ...
    <!-- jQuery -->
    <script src="newTemplate/js/jquery.js"></script>
    <script src="newTemplate/js/bootstrap.min.js"></script>
    <script src="newTemplate/js/owl-carousel/owl.carousel.min.js"></script>
    <script src="newTemplate/js/easytabs/easyResponsiveTabs.js"></script>
    <script src="newTemplate/js/jflickrfeed.min.js"></script>
    <script src="newTemplate/js/jquery.easing.min.js"></script>
    <script src="newTemplate/js/flex-slider/jquery.flexslider.js"></script>
    <script src="newTemplate/js/jCProgress-1.0.3.js"></script>
    <script src="newTemplate/js/jquery.appear.js"></script>
    <script src="newTemplate/js/jquery.inview.js"></script>
    <script src="newTemplate/js/jquery.prettyphoto.js"></script>
    <script src="newTemplate/js/jquery.nicescroll.js"></script>
    <script src="newTemplate/js/contact.js"></script>
    <script src="newTemplate/js/main.js"></script>

    <script src="http://maps.google.com/maps/api/js?sensor=true"></script>
    <script src="../newTemplate/js/gmaps.js"></script>
